...
function AircraftTooltip({ active, payload, label }: any) {
...
export default function AircraftChart({ data }: { data: Aircraft[] }) {
  const chartData = [...data]
    .sort((a, b) => b.total_flights - a.total_flights)
    .map((d) => ({ tail: d.tail, totalFlights: d.total_flights, onTimeRate: d.on_time_rate }));
      ...
      <ResponsiveContainer>
        ...
        >
          ...
          <YAxis
            ...
            width={70}
          />
          <Tooltip content={<AircraftTooltip />} cursor={{ fill: "rgba(255, 255, 255, 0.04)" }} />
